...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	capturer->OverlayingRedTextCaption = _T("Recording: {RUNNINGMIN}:{RUNNINGSEC}:{RUNNINGMSEC} on {CURRENTYEAR}-{CURRENTMONTH}-{CURRENTDAY} at {CURRENTHOUR}:{CURRENTMIN}:{CURRENTSEC}:{CURRENTMSEC}");
