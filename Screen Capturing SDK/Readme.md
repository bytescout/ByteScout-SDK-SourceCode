...
<li><strong>Product Home:</strong> <a href="https://bytescout.com/products/developer/screencapturingsdk/screencapturingsdk.html">Screen Capturing SDK</a></li>
<li><strong>Download:</strong> <a href="https://bytescout.com/download/web-installer">Download Free Trial</a></li>
<li><strong>Documentation:</strong> <a href="http://cdn.bytescout.com/help/BytescoutScreenCapturingSDK/index.html">Screen Capturing SDK Documentation</a></li>
...
<p><a href="https://bytescout.com/products/developer/screencapturingsdk/screencapturingsdk.html">Screen Capturing SDK</a> enables taking rich screenshots with video capture functionality. It can record the whole screen as well as a part of it, it can also capture the mouse surrounding area and track its movement.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/screen-capturing-sdk-samples">Screen Capturing SDK Samples</a> show how to perform rich screen captures with this tool.</p>
<p align="center">
  <a title="Download Screen Capturing SDK free trial" href="https://bytescout.com/download/web-installer">
  <strong>FREE TRIAL</strong></a>
</p>
        <h2>FAQ</h2>
        <p><strong>1. App crashes / "Can't create WMV files" in Event Logs</strong></p>
        <p>The standard edition of Windows 10 should have WMV codecs by default.
You should check "Media Features" are installed.</p>
<p>Proceed to "Control Panel" -> "Programs and Features" -> "Turn Windows features on or off" and ensure "Media Features" are enabled.
https://drive.google.com/open?id=1w1ybZtfsLAC8CLqtlDQ5TY6zagjKAZ0d</p>

<p>In N or KN editions of Windows 10, the media features are not available and there is no official installation by Microsoft for them.
But you can install this unofficial pack:
https://www.codecguide.com/windows_media_codecs.htm</p>

<p>To get WMC codecs on Windows Server your should install "Windows Server Essentials Media Pack":
https://www.microsoft.com/en-us/download/details.aspx?id=40837</p>
