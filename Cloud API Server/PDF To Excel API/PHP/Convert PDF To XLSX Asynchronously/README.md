## How to convert PDF to XLSX asynchronously for PDF to excel API in PHP with ByteScout Cloud API Server
...
$url = "https://localhost/pdf/convert/to/xlsx" . // use `pdf/convert/to/xls` endpoind if you need the old XLS format
    "?url=" . $sourceFileUrl .
    "&password=" . $password .
    "&pages=" . $pages .
