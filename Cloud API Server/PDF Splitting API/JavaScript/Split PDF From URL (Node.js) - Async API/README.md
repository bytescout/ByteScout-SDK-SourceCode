## How to split PDF from URL (node for PDF splitting API in JavaScript using ByteScout Cloud API Server

### Follow this simple tutorial to learn split PDF from URL (node to have PDF splitting API in JavaScript
...
var queryPath = `/pdf/split?pages=${Pages}&url=${SourceFileUrl}&async=True`;
var reqOptions = {
    host: "localhost",
