...
var queryPath = `/pdf/convert/from/doc?name=${path.basename(DestinationFile)}&url=${SourceFileUrl}&async=True`;
var reqOptions = {
    host: "localhost",
