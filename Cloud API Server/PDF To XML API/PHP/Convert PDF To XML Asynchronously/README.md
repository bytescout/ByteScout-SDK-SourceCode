## How to convert PDF to XML asynchronously for PDF to XML API in PHP and ByteScout Cloud API Server
...
<head>
    <meta charset="UTF-8">
    <title>Cloud API asynchronous "PDF To XML" job example (allows to avoid timeout errors).</title>
</head>
<body>
