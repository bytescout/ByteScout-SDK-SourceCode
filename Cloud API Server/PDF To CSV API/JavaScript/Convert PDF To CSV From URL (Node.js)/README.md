## How to convert PDF to CSV from URL (node for PDF to CSV API in JavaScript using ByteScout Cloud API Server

### How to convert PDF to CSV from URL (node in JavaScript with easy ByteScout code samples to make PDF to CSV API. Step-by-step tutorial
...
var queryPath = `/pdf/convert/to/csv?name=${path.basename(DestinationFile)}&password=${Password}&pages=${Pages}&url=${SourceFileUrl}`;
var reqOptions = {
    host: "localhost",
