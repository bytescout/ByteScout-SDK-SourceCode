## How to PDF make searchable API in JavaScript with ByteScout Cloud API Server
...
##### ****MakeSearchablePdfFromFile_AsyncAPI.js:**
...
// Prepare request uri to `Make Searchable PDF` API endpoint
var query = `https://localhost/pdf/makesearchable`;
let reqOptions = {
    uri: query,
    formData: {
