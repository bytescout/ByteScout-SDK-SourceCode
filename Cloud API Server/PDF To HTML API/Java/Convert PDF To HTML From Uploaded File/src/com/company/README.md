...
public class Main
{
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                if (uploadFile(webClient, uploadUrl, SourceFile))
                {
                    ...
                    PdfToHtml(webClient, DestinationFile, Password, Pages, PlainHtml, ColumnLayout, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void PdfToHtml(OkHttpClient webClient, Path destinationFile,
