...
public class Main
{
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                if (uploadFile(webClient, uploadUrl, SourceFile))
                {
                    ...
                    PdfToPng(webClient, Password, Pages, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void PdfToPng(OkHttpClient webClient, String password, String pages, String uploadedFileUrl) throws IOException
    {
