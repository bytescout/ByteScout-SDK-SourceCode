...
### Follow this simple tutorial to learn convert PDF to JPEG from URL (node to have PDF to image API in JavaScript
...
var queryPath = `/pdf/convert/to/jpg?password=${Password}&pages=${Pages}&url=${SourceFileUrl}&async=True`;
var reqOptions = {
    host: "localhost",
