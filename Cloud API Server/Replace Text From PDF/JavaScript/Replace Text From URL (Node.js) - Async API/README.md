...
var jsonPayload = JSON.stringify({
    name: path.basename(DestinationFile), password: Password, url: SourceFileUrl, async: true, searchString: 'The most conspicuous feature of', replaceString: 'replaced text'
});
