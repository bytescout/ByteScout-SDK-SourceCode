...
<head>
    <meta charset="UTF-8">
    <title>Cloud API asynchronous "Replace Text from PDF" job example (allows to avoid timeout errors).</title>
</head>
<body>
...
$url = "https://localhost/pdf/edit/replace-text";
