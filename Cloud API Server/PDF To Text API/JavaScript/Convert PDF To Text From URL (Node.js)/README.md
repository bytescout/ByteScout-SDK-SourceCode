## How to convert PDF to text from URL (node for PDF to text API in JavaScript and ByteScout Cloud API Server

### Learn in simple ways: How to convert PDF to text from URL (node for PDF to text API in JavaScript
...
var queryPath = `/pdf/convert/to/text?name=${path.basename(DestinationFile)}&password=${Password}&pages=${Pages}&url=${SourceFileUrl}`;
var reqOptions = {
    host: "localhost",
