...
function convertCsvToPdf(uploadedFileUrl, destinationFile) {
    ...
    let queryPath = `/pdf/convert/from/csv?name=${path.basename(destinationFile)}&url=${uploadedFileUrl}&async=True`;
    let reqOptions = {
        host: "localhost",
        path: encodeURI(queryPath),
        method: "GET"
