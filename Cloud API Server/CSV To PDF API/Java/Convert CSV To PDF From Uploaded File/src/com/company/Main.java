...
public class Main
{
        ...
        if (response.code() == 200)
        {
            ...
            if (!error)
            {
                ...
                if (uploadFile(webClient, uploadUrl, SourceFile))
                {
                    ...
                    ConvertCsvToPdf(webClient, DestinationFile, uploadedFileUrl);
                }
            }
            else
            {
    ...
    public static void ConvertCsvToPdf(OkHttpClient webClient, Path destinationFile, String uploadedFileUrl) throws IOException 
    {
