...
function readBarcodes(uploadedFileUrl, pages, barcodeTypes) {
    ...
    let queryPath = `/barcode/read/from/url?types=${BarcodeTypes}&pages=${Pages}&url=${uploadedFileUrl}`;
    let reqOptions = {
        host: "localhost",
        path: encodeURI(queryPath),
        method: "GET"
