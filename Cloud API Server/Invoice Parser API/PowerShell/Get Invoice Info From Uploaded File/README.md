...
##### **GetInvoiceInfoFromUploadedFile.ps1:**
...
try {
    ...
    if ($jsonResponse.error -eq $false) {
        ...
        if ($r.StatusCode -eq 200) {
            ...
            $query = "https://localhost/pdf/invoiceparser"
