...
var queryPath = `/pdf/convert/from/url?name=${path.basename(DestinationFile)}&url=${SourceUrl}&async=True`;
var reqOptions = {
    host: "localhost",
