...
namespace ImagePdfBarcodeToCSV.Controllers
{
    /*
    ...
    */
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ProcessIndex()
        {
            ...
            var retSummary = string.Format("Total {0} barcode found in {1} file.", lstCSVOutput.Count, files.Length);

            return Content(retSummary);
        }
        ...
        private void ExportToCsv(List<CSVOutputFormat> lstCSVOutput)
        {
