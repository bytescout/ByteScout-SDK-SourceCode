## How to decode driver license information (pdf417) in C# and ByteScout BarCode Reader SDK ByteScout BarCode Reader SDK: the SDK for reading of barcodes from PDF, images and live camera or video. Almost every common type like Code 39, Code 128, GS1, UPC, QR Code, Datamatrix, PDF417 and many others are supported. Supports noisy and defective images and docs. Includes optional documents splitter and merger for pdf and tiff based on found barcodess. Batch mode is supported for superior performance using multiple threads. Decoded values are easily exported to JSON, CSV, XML and to custom format.
...
##### **ReadDriverLicenseInformation.NETCore.csproj:**
...
##### **ReadDriverLicenseInformation.VS2005.csproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <OutputType>Exe</OutputType>
    <RootNamespace>ReadDriverLicenseInformation</RootNamespace>
    <AssemblyName>ReadDriverLicenseInformation</AssemblyName>
  </PropertyGroup>
...
##### **ReadDriverLicenseInformation.VS2008.csproj:**
...
##### **ReadDriverLicenseInformation.VS2010.csproj:**
