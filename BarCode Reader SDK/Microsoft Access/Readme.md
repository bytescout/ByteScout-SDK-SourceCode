...
<p><a href="https://bytescout.com/products/developer/barcodereadersdk/bytescoutbarcodereadersdk.html">Barcode Reader SDK for MS Access</a> is a great tool that can understand barcodes from TIFF, PNG and JPG images. The tool operates in ActiveX compatible languages as well as .NET 2.00, 3.5, 4.0, 4.5 and ASP.NET. The tool reads linear (Code128, Code39, EAN13, EAN8, GS! Databar, GS1 128 etc) and 2D barcodes (QR code, Aztec, PDF417, Datamatrix, MaxiCode and more) perfectly.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/barcode-reader-sdk-samples-ms-access">Barcode Reader SDK Samples for MS Access</a> to help read different barcode types using this tool.</p>
<p align="center">
...
<tbody>
<tr>
<td><a href="https://github.com/bytescout/barcode-sdk-samples-ms-access">Barcode SDK</a></td>
<td>Samples that help you create 1D and 2D barcodes</td>
</tr></tbody></table>
</article>
  </div>
