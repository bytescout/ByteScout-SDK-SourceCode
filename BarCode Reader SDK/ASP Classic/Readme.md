...
<li><strong>Blog:</strong> <a href="https://bytescout.com/blog">ByteScout Blog</a></li>
    ...
    <p><a href="https://bytescout.com/products/developer/barcodereadersdk/bytescoutbarcodereadersdk.html">BarCode Reader SDK for ASP classic</a> is a useful tool that works in ASP classic, it can understand barcodes from TIFF, PNG and JPG images. The tool reads linear (Code128, Code39, EAN13, EAN8, GS! Databar, GS1 128 etc) and 2D barcodes (QR code, Aztec, PDF417, Datamatrix, MaxiCode and more) perfectly.</p>
...
<p>This repository contains <a href="https://github.com/bytescout/barcode-reader-sdk-samples-asp-classic">Barcode Reader SDK Samples for ASP classic</a> to help read different barcode types using this tool.</p>
<p align="center">
