## inspect decoded barcodes in VB.NET with ByteScout BarCode Reader SDK

### Learn to code inspect decoded barcodes in VB.NET: How-To tutorial

Easy to understand coding instructions are written to assist you to try-out the features without the requirement to write your own code. ByteScout BarCode Reader SDK was made to help with inspect decoded barcodes in VB.NET. ByteScout BarCode Reader SDK is the barcode decoder with support for code 39, code 128, QR Code, Datamatrix, GS1, PDF417 and all other popular barcodes. Can read barcodes from images, pdf, tiff documents and live web camera. Supports noisy and damaged documents, can split and merge pdf and tiff documents based on barcodes. Can export barcode decoder results to XML, JSON, CSV and into custom data structures.

The below SDK samples describe how to quickly make your application do inspect decoded barcodes in VB.NET with the help of ByteScout BarCode Reader SDK. To use inspect decoded barcodes in your VB.NET project or application just copy & paste the code and then run your app! Want to see how it works with your data then code testing will allow the function to be tested and work properly.
...
##### ****InspectDecodedBarcodes.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <StartupObject>InspectDecodedBarcodes.Module1</StartupObject>
    <RootNamespace>InspectDecodedBarcodes</RootNamespace>
    <AssemblyName>InspectDecodedBarcodes</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>InspectDecodedBarcodes.xml</DocumentationFile>
...
##### ****InspectDecodedBarcodes.VS2008.vbproj:**
...
##### ****InspectDecodedBarcodes.VS2010.vbproj:**
