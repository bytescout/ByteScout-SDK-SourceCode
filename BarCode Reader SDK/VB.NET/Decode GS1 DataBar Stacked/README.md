## How to decode gs1 databar stacked in VB.NET using ByteScout BarCode Reader SDK

### How to decode gs1 databar stacked in VB.NET

Learn how to decode gs1 databar stacked in VB.NET with this source code sample. What is ByteScout BarCode Reader SDK? It is the SDK for barcode decoding. Can read all popular types from Code 128, GS1, UPC and Code 39 to QR Code, Datamatrix, PDF417. Images, pdf, TIF images and live web camera are supported as input. Designed to handle documents with noise and defects. Includes optional splitter and merger for pdf and tiff based on barcodes. Batch mode is optimized for high performance with multiple threads. Decoded values can be exported to XML, JSON, CSV or into custom data format. It can help you to decode gs1 databar stacked in your VB.NET application.
...
Module Module1
    ...
    Sub Main()
        ...
        Const imageFile As String = "GS1DataBarStacked.png"
...
##### ****ReadGS1DataBarStacked.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <StartupObject>ReadGS1DataBarStacked.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>ReadGS1DataBarStacked.xml</DocumentationFile>
...
##### ****ReadGS1DataBarStacked.VS2008.vbproj:**
...
##### ****ReadGS1DataBarStacked.VS2010.vbproj:**
