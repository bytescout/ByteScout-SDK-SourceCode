...
<p><a href="https://bytescout.com/products/developer/pdfviewersdk/index.html">PDF Viewer SDK for VB.NET</a> is a developer tool that allows viewing PDF docs in C# library, it supports text searching and copying, multiple pages and works smoothly with the frameworks Microsoft .NET, Mono .NET.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-viewer-sdk-samples-vb-net">PDF Viewer SDK Samples for VB.NET</a> to help create different barcode types using this tool.</p>
<p align="center">
