## How to add watermarks to PDF in C# using ByteScout PDF SDK

### The tutorial below will demonstrate how to add watermarks to PDF in C#

Sample source code below will show you how to cope with a difficult task like add watermarks to PDF in C#. ByteScout PDF SDK is the pdf library that can create, update and modify PDF files. Supports text with fonts and style selections, layers, form fields, drawing lines and objects, automatic tables, images. Can be used to create and fill pdf forms. It can add watermarks to PDF in C#.
