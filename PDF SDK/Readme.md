...
<p><a href="https://bytescout.com/products/developer/pdfsdk/index.html">PDF SDK</a> is a developer tool that easily generates PDF documents, modifies them and works as a complete API supporting font embedding, multimedia, watermarking and more. It allows HTML to PDF conversion, works smoothly in C# and VB.NET.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-sdk-samples">PDF SDK Samples</a> to showcase how to generate and work with PDF files using this tool.</p>
<p align="center">
