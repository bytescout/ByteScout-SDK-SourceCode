...
<p><a href="https://bytescout.com/products/developer/swftovideosdk/swftovideosdk.html">SWF to Video SDK for ASP.NET</a> is a good developer tool that helps work with FLV and SWF formats, supports .NET and ActiveX interfaces. It is completely Mono .NET framework compatible. You can convert SWF to different video formats and also supports conversion to image.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/swf-to-video-sdk-samples-asp-net">SWF to Video SDK Samples for ASP.NET</a> to help you convert SWF format into video files.</p>
<p align="center">
