## correction to deal with date issue after OCR in C# and ByteScout PDF Extractor SDK ByteScout PDF Extractor SDK is the SDK that helps developers to extract data from unstructured documents, pdf, images, scanned and electronic forms. Includes AI functions like automatic table detection, automatic table extraction and restructuring, text recognition and text restoration from pdf and scanned documents. Includes PDF to CSV, PDF to XML, PDF to JSON, PDF to searchable PDF functions as well as methods for low level data extraction.
...
##### **ScannedDocumentToText.NETCore.csproj:**
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <None Include="..\..\InvoiceWithNoise.png" Link="InvoiceWithNoise.png">
...
##### **ScannedDocumentToText.VS2005.csproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <OutputType>Exe</OutputType>
    <RootNamespace>ScannedDocumentToText</RootNamespace>
    <AssemblyName>ScannedDocumentToText</AssemblyName>
  </PropertyGroup>
  ...
  <ItemGroup>
    <Content Include="..\..\InvoiceWithNoise.png">
      <Link>InvoiceWithNoise.png</Link>
      <CopyToOutputDirectory>Always</CopyToOutputDirectory>
    </Content>
  </ItemGroup>
  <ItemGroup>
...
##### **ScannedDocumentToText.VS2008.csproj:**
...
##### **ScannedDocumentToText.VS2010.csproj:**
...
##### **ScannedDocumentToText.VS2012.csproj:**
...
##### **ScannedDocumentToText.VS2013.csproj:**
...
##### **ScannedDocumentToText.VS2015.csproj:**
