...
<p><a href="https://bytescout.com/products/developer/pdfextractorsdk/index.html">PDF Extractor SDK</a> is a useful program that enables extracting any kind of information from your PDF files - tables, metadata, plain text and more. It can also convert PDF to CSV, Excel and XML, merge and split documents, deal with noisy images and has other features.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-extractor-sdk-samples">PDF Extractor Samples</a> to help extract text, metadata and more from PDF files using this tool. You can also find <a href="https://github.com/bytescout/pdf-extractor-sdk-samples/blob/master/Tips.md">Useful Tips</a> here for advanced scenarios.</p>
<p align="center">
