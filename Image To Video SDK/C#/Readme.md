...
<p><a href="https://bytescout.com/products/developer/imagetovideosdk/imagetovideosdk.html">Image to Video SDK for C#</a> is a perfect tool that converts JPG, BMP and PNG images to WMV and AVI video files including 2D and 3D transition effects. The tool supports ActiveX and .NET interfaces. It is Mono .NET compatible, it allows you to choose slide duration and transition effect types.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/image-to-video-sdk-samples-c-sharp">Image to Video SDK Samples for C#</a> to help you convert images to video using this tool.</p>
<p align="center">
...
<td>Program Samples that show how to read 1D and 2D barcodes with the tool</td>
</tr>
<tr>
