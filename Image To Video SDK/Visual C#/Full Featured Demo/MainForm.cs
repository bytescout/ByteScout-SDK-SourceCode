...
namespace ImageToVideoDemo
{
	public partial class MainForm : Form
	{
		...
		protected override void OnLoad(EventArgs e)
		{
			...
			btnBackgroundColor.ForeColor = ColorTranslator.FromOle((int) _imageToVideo.BackgroundColor);
		...
		private void btnCreateMovie_Click(object sender, EventArgs e)
		{
			if (!_imageToVideo.IsRunning)
			{
				...
				if (dlg.ShowDialog() == DialogResult.OK)
				{
					...
					_imageToVideo.BackgroundColor = (uint) ColorTranslator.ToOle(btnBackgroundColor.ForeColor);
