## 70 advanced 3d transition effects in VB.NET with ByteScout Image To Video SDK

### How To: tutorial on 70 advanced 3d transition effects in VB.NET

These source code samples are listed and grouped by their programming language and functions they use. ByteScout Image To Video SDK was made to help with 70 advanced 3d transition effects in VB.NET. ByteScout Image To Video SDK is the SDK that is designed to generate video slideshow with 100+ 2d and 3D transition effects. Can generate WMV, AVI, WEBM video file with adjustable quality, framerate, output video size.
...
##### ****TransitionEffects.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <StartupObject>TransitionEffects.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>TransitionEffects.xml</DocumentationFile>
...
##### ****TransitionEffects.VS2008.vbproj:**
...
##### ****TransitionEffects.VS2010.vbproj:**
