...
<p><a href="https://bytescout.com/products/developer/imagetovideosdk/imagetovideosdk.html">Image to Video SDK for VB.NET</a> is a perfect tool that converts JPG, BMP and PNG images to WMV and AVI video files including 2D and 3D transition effects. The tool supports ActiveX and .NET interfaces. It is Mono .NET compatible, it allows you to choose slide duration and transition effect types.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/image-to-video-sdk-samples-vb-net">Image to Video SDK Samples for VB.NET</a> to help you convert images to video using this tool.</p>
<p align="center">
...
<td>Learn how to read 1D and 2D barcode with these samples</td>
</tr>
<tr>
