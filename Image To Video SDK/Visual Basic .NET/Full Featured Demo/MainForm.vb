...
Public Partial Class MainForm
	...
	Protected Overrides Sub OnLoad(e As EventArgs)
		...
		btnBackgroundColor.ForeColor = ColorTranslator.FromOle(CInt(_imageToVideo.BackgroundColor))
	...
	Private Sub btnCreateMovie_Click(sender As Object, e As EventArgs)
		If Not _imageToVideo.IsRunning Then
			...
			If dlg.ShowDialog() = DialogResult.OK Then
				...
				_imageToVideo.BackgroundColor = CUInt(ColorTranslator.ToOle(btnBackgroundColor.ForeColor))
