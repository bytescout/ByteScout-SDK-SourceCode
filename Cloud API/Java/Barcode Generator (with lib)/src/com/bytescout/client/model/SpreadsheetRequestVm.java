...
import com.bytescout.client.model.SpreadsheetOptionsVm;
...
public class SpreadsheetRequestVm   {
  
  private SpreadsheetOptionsVm properties = null;
  ...
  /**
   **/
  public SpreadsheetRequestVm properties(SpreadsheetOptionsVm properties) {
  ...
  public SpreadsheetOptionsVm getProperties() {
    return properties;
  }
  public void setProperties(SpreadsheetOptionsVm properties) {
    this.properties = properties;
  }
   ...
   **/
  public SpreadsheetRequestVm outputType(OutputTypeEnum outputType) {
   ...
   * Input Data
   **/
  public SpreadsheetRequestVm input(String input) {
    this.input = input;
    return this;
  }
   ...
   * Type of Input Data
   **/
  public SpreadsheetRequestVm inputType(InputTypeEnum inputType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SpreadsheetRequestVm spreadsheetRequestVm = (SpreadsheetRequestVm) o;
    return Objects.equals(this.properties, spreadsheetRequestVm.properties) &&
        Objects.equals(this.outputType, spreadsheetRequestVm.outputType) &&
        Objects.equals(this.input, spreadsheetRequestVm.input) &&
        Objects.equals(this.inputType, spreadsheetRequestVm.inputType);
  }
  ...
  public String toString() {
    ...
    sb.append("class SpreadsheetRequestVm {\n");
