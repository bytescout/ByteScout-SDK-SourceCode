...
import com.bytescout.client.model.PdfRasterRendererOptionsVm;
...
public class PdfRasterRendererRequestVm   {
  
  private PdfRasterRendererOptionsVm properties = null;
  ...
  /**
   **/
  public PdfRasterRendererRequestVm properties(PdfRasterRendererOptionsVm properties) {
  ...
  public PdfRasterRendererOptionsVm getProperties() {
    return properties;
  }
  public void setProperties(PdfRasterRendererOptionsVm properties) {
    this.properties = properties;
  }
   ...
   **/
  public PdfRasterRendererRequestVm outputType(OutputTypeEnum outputType) {
   ...
   * Input Data
   **/
  public PdfRasterRendererRequestVm input(String input) {
    this.input = input;
    return this;
  }
   ...
   * Type of Input Data
   **/
  public PdfRasterRendererRequestVm inputType(InputTypeEnum inputType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PdfRasterRendererRequestVm pdfRasterRendererRequestVm = (PdfRasterRendererRequestVm) o;
    return Objects.equals(this.properties, pdfRasterRendererRequestVm.properties) &&
        Objects.equals(this.outputType, pdfRasterRendererRequestVm.outputType) &&
        Objects.equals(this.input, pdfRasterRendererRequestVm.input) &&
        Objects.equals(this.inputType, pdfRasterRendererRequestVm.inputType);
  }
  ...
  public String toString() {
    ...
    sb.append("class PdfRasterRendererRequestVm {\n");
