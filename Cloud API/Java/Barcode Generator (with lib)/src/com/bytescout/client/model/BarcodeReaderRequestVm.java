...
import com.bytescout.client.model.BarcodeReaderOptionsVm;
...
public class BarcodeReaderRequestVm   {
  
  private BarcodeReaderOptionsVm properties = null;
  ...
  /**
   **/
  public BarcodeReaderRequestVm properties(BarcodeReaderOptionsVm properties) {
  ...
  public BarcodeReaderOptionsVm getProperties() {
    return properties;
  }
  public void setProperties(BarcodeReaderOptionsVm properties) {
    this.properties = properties;
  }
   ...
   **/
  public BarcodeReaderRequestVm outputType(OutputTypeEnum outputType) {
   ...
   * Input Data
   **/
  public BarcodeReaderRequestVm input(String input) {
    this.input = input;
    return this;
  }
   ...
   * Type of Input Data
   **/
  public BarcodeReaderRequestVm inputType(InputTypeEnum inputType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BarcodeReaderRequestVm barcodeReaderRequestVm = (BarcodeReaderRequestVm) o;
    return Objects.equals(this.properties, barcodeReaderRequestVm.properties) &&
        Objects.equals(this.outputType, barcodeReaderRequestVm.outputType) &&
        Objects.equals(this.input, barcodeReaderRequestVm.input) &&
        Objects.equals(this.inputType, barcodeReaderRequestVm.inputType);
  }
  ...
  public String toString() {
    ...
    sb.append("class BarcodeReaderRequestVm {\n");
