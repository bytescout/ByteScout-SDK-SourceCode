...
import com.bytescout.client.model.TextExtractorOptionsVm;
...
public class TextExtractorRequestVm   {
  
  private TextExtractorOptionsVm properties = null;
  ...
  /**
   * Options of TextExtractor (optional)
   **/
  public TextExtractorRequestVm properties(TextExtractorOptionsVm properties) {
    this.properties = properties;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Options of TextExtractor (optional)")
  @JsonProperty("properties")
  public TextExtractorOptionsVm getProperties() {
    return properties;
  }
  public void setProperties(TextExtractorOptionsVm properties) {
    this.properties = properties;
  }
   ...
   **/
  public TextExtractorRequestVm outputType(OutputTypeEnum outputType) {
   ...
   * Input Data
   **/
  public TextExtractorRequestVm input(String input) {
    this.input = input;
    return this;
  }
   ...
   * Type of Input Data
   **/
  public TextExtractorRequestVm inputType(InputTypeEnum inputType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TextExtractorRequestVm textExtractorRequestVm = (TextExtractorRequestVm) o;
    return Objects.equals(this.properties, textExtractorRequestVm.properties) &&
        Objects.equals(this.outputType, textExtractorRequestVm.outputType) &&
        Objects.equals(this.input, textExtractorRequestVm.input) &&
        Objects.equals(this.inputType, textExtractorRequestVm.inputType);
  }
  ...
  public String toString() {
    ...
    sb.append("class TextExtractorRequestVm {\n");
