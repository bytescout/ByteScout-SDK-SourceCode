	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			try
			{
				...
				SingleResponseModel conversionResponse = apiInstance.PdfConvertToXlsxGet(pages, fileName, uploadedFileAccessUrl);
				// Use PdfConvertToXlsGet() method if you need the old XLS format
