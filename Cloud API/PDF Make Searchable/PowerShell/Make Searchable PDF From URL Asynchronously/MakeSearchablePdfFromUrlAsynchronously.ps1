...
$query = "https://bytescout.io/v1/pdf/makesearchable?name={0}&password={1}&pages={2}&lang={3}&url={4}&async={5}" -f `
    $(Split-Path $DestinationFile -Leaf), $Password, $Pages, $Language, $SourceFileURL, $Async
