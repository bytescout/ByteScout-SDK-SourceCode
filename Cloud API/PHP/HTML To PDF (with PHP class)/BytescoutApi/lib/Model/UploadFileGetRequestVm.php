...
use \ArrayAccess;
/**
 * UploadFileGetRequestVm Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Bytescout\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UploadFileGetRequestVm implements ArrayAccess
{
    /**
    ...
    /**
      * $storageTime Time of storing of a file on server (seconds) (optional).\r\n            Default value: 1800
      * @var int
      */
