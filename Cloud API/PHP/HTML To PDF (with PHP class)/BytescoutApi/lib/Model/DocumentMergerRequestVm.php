...
use \ArrayAccess;
/**
 * DocumentMergerRequestVm Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Bytescout\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DocumentMergerRequestVm implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        'properties' => '\Bytescout\Client\Model\DocumentMergerOptionsVm',
        'outputType' => 'string',
        'inputFileIds' => 'string[]'
    );
    ...
    /**
      * $properties 
      * @var \Bytescout\Client\Model\DocumentMergerOptionsVm
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->inputFileIds = $data["inputFileIds"];
        }
    }
    
    /**
     * Gets properties
     * @return \Bytescout\Client\Model\DocumentMergerOptionsVm
     */
    ...
    /**
     * Sets properties
     * @param \Bytescout\Client\Model\DocumentMergerOptionsVm $properties 
     * @return $this
     */
     ...
     * @return string[]
     */
    public function getInputFileIds()
    {
    ...
    /**
     * Sets inputFileIds
     * @param string[] $inputFileIds 
     * @return $this
     */
    public function setInputFileIds($inputFileIds)
    {
