...
public class HtmlToPdfRequestVm   {
  
  private HtmlToPdfOptionsVm properties = null;
   ...
   **/
  public HtmlToPdfRequestVm properties(HtmlToPdfOptionsVm properties) {
    this.properties = properties;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "Options of conversion.")
  @JsonProperty("properties")
  public HtmlToPdfOptionsVm getProperties() {
    return properties;
  }
  public void setProperties(HtmlToPdfOptionsVm properties) {
    this.properties = properties;
  }
   ...
   **/
  public HtmlToPdfRequestVm outputType(OutputTypeEnum outputType) {
   ...
   * Input Data
   **/
  public HtmlToPdfRequestVm input(String input) {
    this.input = input;
    return this;
  }
   ...
   * Type of Input Data
   **/
  public HtmlToPdfRequestVm inputType(InputTypeEnum inputType) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HtmlToPdfRequestVm htmlToPdfRequestVm = (HtmlToPdfRequestVm) o;
    return Objects.equals(this.properties, htmlToPdfRequestVm.properties) &&
        Objects.equals(this.outputType, htmlToPdfRequestVm.outputType) &&
        Objects.equals(this.input, htmlToPdfRequestVm.input) &&
        Objects.equals(this.inputType, htmlToPdfRequestVm.inputType);
  }
  ...
  public String toString() {
    ...
    sb.append("class HtmlToPdfRequestVm {\n");
