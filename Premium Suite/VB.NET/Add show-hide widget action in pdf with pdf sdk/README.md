## How to add show hide widget action in pdf with pdf sdk in VB.NET using ByteScout Premium Suite

### Learn to add show hide widget action in pdf with pdf sdk in VB.NET

Quickly learn how to add show hide widget action in pdf with pdf sdk in VB.NET with this sample source code. ByteScout Premium Suite is the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording. It can be applied to add show hide widget action in pdf with pdf sdk using VB.NET.

The SDK samples given below describe how to quickly make your application do add show hide widget action in pdf with pdf sdk in VB.NET with the help of ByteScout Premium Suite. IF you want to implement the functionality, just copy and paste this code for VB.NET below into your code editor with your app, compile and run your application. This basic programming language sample code for VB.NET will do the whole work for you to add show hide widget action in pdf with pdf sdk.
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <RootNamespace>ShowHideWidget</RootNamespace>
    <AssemblyName>ShowHideWidget</AssemblyName>
