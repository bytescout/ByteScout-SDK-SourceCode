## How to batch read from files with barcode reader sdk in VB.NET with ByteScout Premium Suite

### Learning is essential in computer world and the tutorial below will demonstrate how to batch read from files with barcode reader sdk in VB.NET

This sample source code below will display you how to batch read from files with barcode reader sdk in VB.NET. ByteScout Premium Suite: the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording. It can batch read from files with barcode reader sdk in VB.NET.
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <StartupObject>BatchProcessing.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>BatchProcessing.xml</DocumentationFile>
