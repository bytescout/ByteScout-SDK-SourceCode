## How to set PDF viewer selection options and use custompaint event with PDF viewer SDK in VB.NET and ByteScout Premium Suite

### Learn to code in VB.NET to set PDF viewer selection options and use custompaint event with PDF viewer SDK with this step-by-step tutorial

These sample source codes on this page below are displaying how to set PDF viewer selection options and use custompaint event with PDF viewer SDK in VB.NET. ByteScout Premium Suite is the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording and you can use it to set PDF viewer selection options and use custompaint event with PDF viewer SDK with VB.NET.

The following code snippet for ByteScout Premium Suite works best when you need to quickly set PDF viewer selection options and use custompaint event with PDF viewer SDK in your VB.NET application. This VB.NET sample code is all you need for your app. Just copy and paste the code, add references (if needs to) and you are all set! Further improvement of the code will make it more robust.
