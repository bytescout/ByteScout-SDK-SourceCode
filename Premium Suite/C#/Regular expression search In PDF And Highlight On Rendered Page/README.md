## How to regular expression search in PDF and highlight on rendered page in C# using ByteScout Premium Suite

### Learn to code in C# to regular expression search in PDF and highlight on rendered page with this step-by-step tutorial

Quickly learn how to regular expression search in PDF and highlight on rendered page in C# with this sample source code. ByteScout Premium Suite can regular expression search in PDF and highlight on rendered page. It can be applied from C#. ByteScout Premium Suite is the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording.
