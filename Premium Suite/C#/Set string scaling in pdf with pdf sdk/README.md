## How to set string scaling in pdf with pdf sdk in C# with ByteScout Premium Suite

### Learn to code in C# to set string scaling in pdf with pdf sdk with this step-by-step tutorial

An easy to understand sample source code to learn how to set string scaling in pdf with pdf sdk in C# Want to set string scaling in pdf with pdf sdk in your C# app? ByteScout Premium Suite is designed for it. ByteScout Premium Suite is the bundle that includes twelve SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording.
