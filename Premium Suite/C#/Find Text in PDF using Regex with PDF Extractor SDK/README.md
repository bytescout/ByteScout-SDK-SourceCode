## How to find text in PDF using regex with PDF extractor SDK in C# with ByteScout Premium Suite

### Step-by-step tutorial on how to find text in PDF using regex with PDF extractor SDK in C#

The sample source codes on this page shows how to find text in PDF using regex with PDF extractor SDK in C#. What is ByteScout Premium Suite? It is the bundle that includes twelve SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording. It can help you to find text in PDF using regex with PDF extractor SDK in your C# application.
