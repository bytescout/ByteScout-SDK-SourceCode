## How to add images to pdf with pdf sdk in C# and ByteScout Premium Suite

### Learn to add images to pdf with pdf sdk in C#

This sample source code below will display you how to add images to pdf with pdf sdk in C#. What is ByteScout Premium Suite? It is the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording. It can help you to add images to pdf with pdf sdk in your C# application.
