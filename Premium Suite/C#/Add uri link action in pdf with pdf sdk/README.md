## How to add uri link action in pdf with pdf sdk in C# using ByteScout Premium Suite ByteScout Premium Suite is the set that includes 12 SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording.
