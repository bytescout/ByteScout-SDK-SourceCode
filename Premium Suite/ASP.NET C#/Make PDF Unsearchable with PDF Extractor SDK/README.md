## How to make PDF unsearchable with PDF extractor SDK in ASP.NET C# using ByteScout Premium Suite

### This code in ASP.NET C# shows how to make PDF unsearchable with PDF extractor SDK with this how to tutorial

The documentation is designed for a specific purpose to help you to apply the features on your side. ByteScout Premium Suite is the bundle that includes twelve SDK products from ByteScout including tools and components for PDF, barcodes, spreadsheets, screen video recording. It can be applied to make PDF unsearchable with PDF extractor SDK using ASP.NET C#.

Want to save time? You will save a lot of time on writing and testing code as you may just take the ASP.NET C# code from ByteScout Premium Suite for make PDF unsearchable with PDF extractor SDK below and use it in your application. This ASP.NET C# sample code is all you need for your app. Just copy and paste the code, add references (if needs to) and you are all set! If you want to use these ASP.NET C# sample examples in one or many applications then they can be used easily.
...
```
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MakePDFUnsearchable._Default" %>
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="4.0">
  ...
  <PropertyGroup>
    ...
    <RootNamespace>MakePDFUnsearchable</RootNamespace>
    <AssemblyName>MakePDFUnsearchable</AssemblyName>
    <FileUpgradeFlags>
    </FileUpgradeFlags>
...
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "MakePDFUnsearchable", "MakePDFUnsearchable.csproj", "{A8705DB2-82C7-46E7-8786-058EEE78DE9D}"
EndProject
Global
