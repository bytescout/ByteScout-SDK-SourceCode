## How to copypaste rows in Delphi and ByteScout Spreadsheet SDK ByteScout Spreadsheet SDK: the SDK that can write and read, modify and calculate Excel and CSV spreadsheets. Most popular formulas are supported. You may import or export data to and from CSV, XML, JSON as well as to and from databases, arrays.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{6B4C4812-058E-49FB-817B-912A7866D609}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">CopyPasteRows.dpr</Source>
    </Source>
    <FileVersion>
