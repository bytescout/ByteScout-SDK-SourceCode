## How to add image to spreadsheet in Delphi and ByteScout Spreadsheet SDK What is ByteScout Spreadsheet SDK? It is the SDK that can write and read, modify and calculate Excel and CSV spreadsheets. Most popular formulas are supported. You may import or export data to and from CSV, XML, JSON as well as to and from databases, arrays.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{3B9E4F50-6AAE-422A-B37B-F17285FD20D4}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">AddImage.dpr</Source>
    </Source>
    <FileVersion>
