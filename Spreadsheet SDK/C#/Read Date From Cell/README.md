## How to read date from cell in C# using ByteScout Spreadsheet SDK

### The tutorial below will demonstrate how to read date from cell in C#

These sample source codes on this page below are demonstrating how to read date from cell in C#. ByteScout Spreadsheet SDK is the library (SDK) that is capable of writing, reading, modifying and calculating Excel and CSV spreadsheets. Most popular formulas can be calculated and reculculated with Excel installed. You may import or export data to and from CSV, XML, JSON as well as to and from databases, arrays. It can read date from cell in C#.
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{EEC7C332-E2A0-43E4-ACD7-0297F0D32873}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <AppDesignerFolder>Properties</AppDesignerFolder>
    <RootNamespace>ReadDates</RootNamespace>
    <AssemblyName>ReadDates</AssemblyName>
  </PropertyGroup>
