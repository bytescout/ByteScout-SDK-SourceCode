## How to copy worksheet data to clipboard in C# with ByteScout Spreadsheet SDK ByteScout Spreadsheet SDK is the SDK that can write and read, modify and calculate Excel and CSV spreadsheets. Most popular formulas are supported. You may import or export data to and from CSV, XML, JSON as well as to and from databases, arrays.
...
##### **CopyWorksheetDataToClipboard.VS2005.csproj:**
...
##### **CopyWorksheetDataToClipboard.VS2008.csproj:**
...
##### **CopyWorksheetDataToClipboard.VS2010.csproj:**
