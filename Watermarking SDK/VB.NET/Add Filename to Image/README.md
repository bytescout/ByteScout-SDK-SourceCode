## How to add filename to image for filename (vb in VB.NET and ByteScout Watermarking SDK
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{ACF76867-C559-4FA1-96FD-07F2386064C4}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>FileName__VB.NET_.Module1</StartupObject>
    <RootNamespace>FileName__VB.NET_</RootNamespace>
    <AssemblyName>FileName %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>FileName__VB.NET_.xml</DocumentationFile>
