...
##### ****StampFitsPageColor (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{595F4513-0CE3-41DE-B3A7-439DE6B4A8EE}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>StampFitsPageColor__VB.NET_.Module1</StartupObject>
    <RootNamespace>StampFitsPageColor__VB.NET_</RootNamespace>
    <AssemblyName>StampFitsPageColor %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>StampFitsPageColor__VB.NET_.xml</DocumentationFile>
...
##### ****StampFitsPageColor (VB.NET).VS2008.vbproj:**
...
##### ****StampFitsPageColor (VB.NET).VS2010.vbproj:**
...
##### ****StampFitsPageColor (VB.NET).vbproj:**
