...
##### ****LogoImage (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{942DE721-0B75-4AB8-8422-24F9F799AC11}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>LogoImage__VB.NET_.Module1</StartupObject>
    <RootNamespace>LogoImage__VB.NET_</RootNamespace>
    <AssemblyName>LogoImage %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>LogoImage__VB.NET_.xml</DocumentationFile>
...
##### ****LogoImage (VB.NET).VS2008.vbproj:**
...
##### ****LogoImage (VB.NET).VS2010.vbproj:**
