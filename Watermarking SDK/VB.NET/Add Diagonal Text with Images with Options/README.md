...
##### ****TextFitsPageDiagonal (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{2A74D2D5-7992-43E0-AD91-1FCE7C1D464F}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>TextFitsPageDiagonal__VB.NET_.Module1</StartupObject>
    <RootNamespace>TextFitsPageDiagonal__VB.NET_</RootNamespace>
    <AssemblyName>TextFitsPageDiagonal %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>TextFitsPageDiagonal__VB.NET_.xml</DocumentationFile>
...
##### ****TextFitsPageDiagonal (VB.NET).VS2008.vbproj:**
...
##### ****TextFitsPageDiagonal (VB.NET).VS2010.vbproj:**
...
##### ****TextFitsPageDiagonal (VB.NET).vbproj:**
