## How to set options for text watermark for textfitspage (vb in VB.NET using ByteScout Watermarking SDK
...
##### ****TextFitsPage (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{A4BCEA72-64C7-4CBF-8D7C-0BBC4ADAC9E4}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>TextFitsPage__VB.NET_.Module1</StartupObject>
    <RootNamespace>TextFitsPage__VB.NET_</RootNamespace>
    <AssemblyName>TextFitsPage %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>TextFitsPage__VB.NET_.xml</DocumentationFile>
...
##### ****TextFitsPage (VB.NET).VS2008.vbproj:**
...
##### ****TextFitsPage (VB.NET).VS2010.vbproj:**
