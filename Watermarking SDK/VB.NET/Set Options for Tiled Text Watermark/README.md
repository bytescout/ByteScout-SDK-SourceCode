## How to set options for tiled text watermark for tiledtext (vb in VB.NET and ByteScout Watermarking SDK
...
##### ****TiledText (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{F4623453-A212-4278-9ED7-2CE91D458BEF}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>TiledText__VB.NET_.Module1</StartupObject>
    <RootNamespace>TiledText__VB.NET_</RootNamespace>
    <AssemblyName>TiledText %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>TiledText__VB.NET_.xml</DocumentationFile>
...
##### ****TiledText (VB.NET).VS2008.vbproj:**
...
##### ****TiledText (VB.NET).VS2010.vbproj:**
