...
##### ****AnnotationMacros  (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{71151B5B-BE3B-48DA-84C5-E855D95CDA6F}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>AnnotationMacros___VB.NET_.Module1</StartupObject>
    <RootNamespace>AnnotationMacros___VB.NET_</RootNamespace>
    <AssemblyName>AnnotationMacros  %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>AnnotationMacros___VB.NET_.xml</DocumentationFile>
...
##### ****AnnotationMacros  (VB.NET).VS2008.vbproj:**
...
##### ****AnnotationMacros  (VB.NET).VS2010.vbproj:**
...
##### ****AnnotationMacros  (VB.NET).vbproj:**
