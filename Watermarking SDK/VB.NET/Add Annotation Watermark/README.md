## How to add annotation watermark in VB.NET using ByteScout Watermarking SDK
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{19BD8A7C-6ACB-4173-9804-DF6B2EEEE04A}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Annotation.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>Annotation.xml</DocumentationFile>
...
Module Module1
    ...
    Sub Main()
        ...
        Dim preset As New Presets.TextAnnotation()
