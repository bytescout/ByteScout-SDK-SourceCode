## How to add while page text watermark to image for text fits page in VB.NET with ByteScout Watermarking SDK
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{C8B73B99-5321-4125-A082-7CDE53592A63}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>TextFitsPage.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>TextFitsPage.xml</DocumentationFile>
