## How to add stamp for whole image for stamp fits page in VB.NET with ByteScout Watermarking SDK
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{2563D3F6-4264-4A70-BED8-541436B01E00}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>StampFitsPage.Module1</StartupObject>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>StampFitsPage.xml</DocumentationFile>
