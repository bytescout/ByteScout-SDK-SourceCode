...
##### ****LogoImageWithText preset (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{BE3216E6-5A7F-45C6-89D2-42EF517F9209}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>LogoImageWithText_preset__VB.NET_.Module1</StartupObject>
    <RootNamespace>LogoImageWithText_preset__VB.NET_</RootNamespace>
    <AssemblyName>LogoImageWithText preset %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>LogoImageWithText_preset__VB.NET_.xml</DocumentationFile>
...
##### ****LogoImageWithText preset (VB.NET).VS2008.vbproj:**
...
##### ****LogoImageWithText preset (VB.NET).VS2010.vbproj:**
...
##### ****LogoImageWithText preset (VB.NET).vbproj:**
