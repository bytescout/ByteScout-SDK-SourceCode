## How to add vertical text with options for simpleverticaltext (vb in VB.NET and ByteScout Watermarking SDK
...
##### ****SimpleVerticalText (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{2B46B515-4620-4ED2-B313-AF932090157C}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>SimpleVerticalText__VB.NET_.Module1</StartupObject>
    <RootNamespace>SimpleVerticalText__VB.NET_</RootNamespace>
    <AssemblyName>SimpleVerticalText %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>SimpleVerticalText__VB.NET_.xml</DocumentationFile>
...
##### ****SimpleVerticalText (VB.NET).VS2008.vbproj:**
...
##### ****SimpleVerticalText (VB.NET).VS2010.vbproj:**
...
##### ****SimpleVerticalText (VB.NET).vbproj:**
