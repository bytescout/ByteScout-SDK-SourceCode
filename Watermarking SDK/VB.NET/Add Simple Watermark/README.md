## How to add simple watermark for hello_world_vb in VB.NET and ByteScout Watermarking SDK
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{5D114536-8339-4B9F-8523-F4E3B24B145E}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>hello_world_vb.Module1</StartupObject>
    <RootNamespace>hello_world_vb</RootNamespace>
    <AssemblyName>hello_world_vb</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>hello_world_vb.xml</DocumentationFile>
