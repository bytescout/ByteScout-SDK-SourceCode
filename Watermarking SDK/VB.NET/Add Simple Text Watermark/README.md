...
### See how to add simple text watermark to have simpletext (vb in VB.NET

The documentation is designed to help you to implement the features on your side. ByteScout Watermarking SDK helps with simpletext (vb in VB.NET. ByteScout Watermarking SDK is the software development kit that helps to quickly implement adding of watermarks on top of PNG, JPG, BMP images as well as on multipaged TIFF files. You may select ready to use presets or create your own preset with semitransparent logo images, text lines with adjustable font size, family, color, rotation.

VB.NET code snippet like this for ByteScout Watermarking SDK works best when you need to quickly implement simpletext (vb in your VB.NET application. This VB.NET sample code should be copied and pasted into your project. After doing this just compile your project and click Run. You can use these VB.NET sample examples in one or many applications.
...
##### ****SimpleText (VB.NET).VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{F922134B-2D52-4F66-942C-A8F1378A19F8}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>SimpleText__VB.NET_.Module1</StartupObject>
    <RootNamespace>SimpleText__VB.NET_</RootNamespace>
    <AssemblyName>SimpleText %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>SimpleText__VB.NET_.xml</DocumentationFile>
...
##### ****SimpleText (VB.NET).VS2008.vbproj:**
...
##### ****SimpleText (VB.NET).VS2010.vbproj:**
