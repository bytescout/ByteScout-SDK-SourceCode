...
##### ****Fit within resize VB.NET.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{4BBA28DD-5B72-4CB7-A2C6-62C8B18D34B4}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Fit_within_resize_VB.NET.Module1</StartupObject>
    <RootNamespace>Fit_within_resize_VB.NET</RootNamespace>
    <AssemblyName>Fit within resize VB.NET</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>Fit_within_resize_VB.NET.xml</DocumentationFile>
...
##### ****Fit within resize VB.NET.VS2008.vbproj:**
...
##### ****Fit within resize VB.NET.VS2010.vbproj:**
...
##### ****Fit within resize VB.NET.vbproj:**
