## How to use rich formatting to create report with spreadsheet sdk in VB.NET using ByteScout Data Extraction Suite

### Learn to use rich formatting to create report with spreadsheet sdk in VB.NET

Source code documentation samples give simple and easy method to install a needed feature into your application. Want to use rich formatting to create report with spreadsheet sdk in your VB.NET app? ByteScout Data Extraction Suite is designed for it. ByteScout Data Extraction Suite is the bundle that includes three SDK tools for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK.
...
##### ****Use Rich Formatting to Create Report.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{2D631465-F43A-4E34-8A5E-F9730489B15F}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Using_rich_formatting__VB.NET_.Module1</StartupObject>
    <RootNamespace>Using_rich_formatting__VB.NET_</RootNamespace>
    <AssemblyName>Using rich formatting %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>Using_rich_formatting__VB.NET_.xml</DocumentationFile>
...
##### ****Use Rich Formatting to Create Report.VS2008.vbproj:**
...
##### ****Use Rich Formatting to Create Report.VS2010.vbproj:**
