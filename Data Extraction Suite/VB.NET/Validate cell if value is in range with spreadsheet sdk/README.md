## validate cell if value is in range with spreadsheet sdk in VB.NET using ByteScout Data Extraction Suite
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{D854BD3B-B74C-4FFE-9D54-0C47494AD276}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Validating_cells_if_cell_value_is_in_the_range.Module1</StartupObject>
    <RootNamespace>Validating_cells_if_cell_value_is_in_the_range</RootNamespace>
    <AssemblyName>ValidateCells</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>ValidateCells.xml</DocumentationFile>
