## How to optimize pdf with pdf extractor sdk in VB.NET with ByteScout Data Extraction Suite
...
The documentation is designed for a specific purpose to help you to apply the features on your side. ByteScout Data Extraction Suite is the bundle that includes three SDK tools for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK. It can be applied to optimize pdf with pdf extractor sdk using VB.NET.
