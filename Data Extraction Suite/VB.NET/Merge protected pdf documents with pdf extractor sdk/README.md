## How to merge protected pdf documents with pdf extractor sdk in VB.NET with ByteScout Data Extraction Suite

### Step-by-step tutorial on how to merge protected pdf documents with pdf extractor sdk in VB.NET

Merge protected pdf documents with pdf extractor sdk is simple to apply in VB.NET if you use these source codes below. ByteScout Data Extraction Suite: the bundle that includes three SDK tools for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK. It can merge protected pdf documents with pdf extractor sdk in VB.NET.
