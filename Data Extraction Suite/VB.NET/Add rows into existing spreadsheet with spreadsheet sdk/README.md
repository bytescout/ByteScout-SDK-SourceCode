...
Want to save time? You will save a lot of time on writing and testing code as you may just take the VB.NET code from ByteScout Data Extraction Suite for add rows into existing spreadsheet with spreadsheet sdk below and use it in your application. Follow the instructions from scratch to work and copy the VB.NET code. Complete and detailed tutorials and documentation are available along with installed ByteScout Data Extraction Suite if you'd like to learn more about the topic and the details of the API.
...
##### ****Add Rows Into Existing Spreadsheet.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{78489B44-7EC7-47E8-AE1F-0AAA498C62BE}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Adding_rows_to_existing_XLS__VB.NET_.Module1</StartupObject>
    <RootNamespace>Adding_rows_to_existing_XLS__VB.NET_</RootNamespace>
    <AssemblyName>Adding rows to existing XLS %28VB.NET%29</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>Adding_rows_to_existing_XLS__VB.NET_.xml</DocumentationFile>
...
##### ****Add Rows Into Existing Spreadsheet.VS2008.vbproj:**
...
##### ****Add Rows Into Existing Spreadsheet.VS2010.vbproj:**
