## swap cells and their values with spreadsheet sdk in VB.NET with ByteScout Data Extraction Suite

### Learn swap cells and their values with spreadsheet sdk in VB.NET

These source code samples are assembled by their programming language and functions they use. Swap cells and their values with spreadsheet sdk in VB.NET can be applied with ByteScout Data Extraction Suite. ByteScout Data Extraction Suite is the bundle that includes three SDK tools for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK.
...
##### ****Swap Cells and Their Values.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <ProjectGuid>{EE558CA0-B36B-47E9-908C-08C4B520ED33}</ProjectGuid>
    <OutputType>Exe</OutputType>
    <StartupObject>Swap_cells_and_its_values_VB.NET.Module1</StartupObject>
    <RootNamespace>Swap_cells_and_its_values_VB.NET</RootNamespace>
    <AssemblyName>Swap cells and its values VB.NET</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>Swap_cells_and_its_values_VB.NET.xml</DocumentationFile>
...
##### ****Swap Cells and Their Values.VS2008.vbproj:**
...
##### ****Swap Cells and Their Values.VS2010.vbproj:**
