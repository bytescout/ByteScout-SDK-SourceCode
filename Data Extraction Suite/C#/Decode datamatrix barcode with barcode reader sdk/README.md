## How to decode datamatrix barcode with barcode reader sdk in C# and ByteScout Data Extraction Suite
...
This sample source code below will display you how to decode datamatrix barcode with barcode reader sdk in C#. What is ByteScout Data Extraction Suite? It is the bundle that includes three SDK tools for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK. It can help you to decode datamatrix barcode with barcode reader sdk in your C# application.
