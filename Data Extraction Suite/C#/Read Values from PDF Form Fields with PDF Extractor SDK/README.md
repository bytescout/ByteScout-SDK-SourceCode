## How to read values from PDF form fields with PDF extractor SDK in C# with ByteScout Data Extraction Suite
...
##### ****ReadValuesFromFormFields.NETCore.csproj:**
...
##### ****ReadValuesFromFormFields.csproj:**
