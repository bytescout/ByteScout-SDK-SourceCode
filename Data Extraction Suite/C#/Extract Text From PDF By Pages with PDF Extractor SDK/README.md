## How to extract text from PDF by pages with PDF extractor SDK in C# and ByteScout Data Extraction Suite

### This code in C# shows how to extract text from PDF by pages with PDF extractor SDK with this how to tutorial
