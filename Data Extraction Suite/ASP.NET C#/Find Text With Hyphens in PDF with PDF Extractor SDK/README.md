## How to find text with hyphens in PDF with PDF extractor SDK in ASP.NET C# using ByteScout Data Extraction Suite

### Learn to find text with hyphens in PDF with PDF extractor SDK in ASP.NET C#

The coding instructions are formulated to help you to try-out the features without the requirement to write your own code. ByteScout Data Extraction Suite can find text with hyphens in PDF with PDF extractor SDK. It can be applied from ASP.NET C#. ByteScout Data Extraction Suite is the set that includes 3 SDK products for data extraction from PDF, scans, images and from spreadsheets: PDF Extractor SDK, Data Extraction SDK, Barcode Reader SDK.

The following code snippet for ByteScout Data Extraction Suite works best when you need to quickly find text with hyphens in PDF with PDF extractor SDK in your ASP.NET C# application. Follow the instructions from scratch to work and copy the ASP.NET C# code. If you want to use these ASP.NET C# sample examples in one or many applications then they can be used easily.
