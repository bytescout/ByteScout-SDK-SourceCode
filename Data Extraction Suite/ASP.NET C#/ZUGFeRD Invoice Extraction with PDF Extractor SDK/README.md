## zugferd invoice extraction with PDF extractor SDK in ASP.NET C# and ByteScout Data Extraction Suite
...
```
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ZUGFeRDInvoiceExtraction._Default" %>
...
##### ****ZUGFeRDInvoiceExtraction.csproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="4.0">
  ...
  <PropertyGroup>
    ...
    <RootNamespace>ZUGFeRDInvoiceExtraction</RootNamespace>
    <AssemblyName>ZUGFeRDInvoiceExtraction</AssemblyName>
  ...
  <ItemGroup>
    <Content Include="..\..\zugferd_invoice.pdf">
      <Link>zugferd_invoice.pdf</Link>
...
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "ZUGFeRDInvoiceExtraction", "ZUGFeRDInvoiceExtraction.csproj", "{0C256397-34FA-4067-98A7-01D3D2BE0F7E}"
EndProject
Global
