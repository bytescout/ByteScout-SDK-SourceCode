## How to convert PDF to HTML (with complex layout) from all pages in Delphi and ByteScout PDF To HTML SDK ByteScout PDF To HTML SDK is the SDK for PDF to HTML conversin. Generates static HTML version of input PDF and reconstructs all visual layout, text positions, vector and raster drawings, images, and form elements. Generated HTML requires no special software and can be viewed in any Internet browser.
...
##### **ExtractHTMLComplexLayout.bdsproj:**
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{DD4A4EA9-53E0-44F5-B15A-9E7D58EEE185}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">ExtractHTMLComplexLayout.dpr</Source>
    </Source>
    <FileVersion>
...
##### **ExtractHTMLComplexLayout.dpr:**
    
```
program ExtractHTMLComplexLayout;
...
begin
  ...
  extractor.ExtractionMode := HTMLExtractionMode_HTMLWithCSS;
