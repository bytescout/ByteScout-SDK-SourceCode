## download and process file in Delphi with ByteScout PDF To HTML SDK ByteScout PDF To HTML SDK: the PDF to HTML converter with visual layout, positions, vectors, images and form fields. Generated HTML can be viewed using browser without PDF reader.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{78EF9DF3-3C76-4FCF-8B6C-E47D588444C2}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">ExtractHTMLFromPage.dpr</Source>
    </Source>
    <FileVersion>
