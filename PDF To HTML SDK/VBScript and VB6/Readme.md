...
<p><a href="https://bytescout.com/products/developer/pdftohtmlsdk/pdftohtmlsdk.html">PDF to HTML SDK for VBScript</a> is a well-performing tool that easily converts PDF files into HTML in C#. The layout, images and tables are preserved. The tool works in .NET, ASP.NET, ActiveX, operates fast and smoothly and is easy-to-use.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-to-html-sdk-samples-vbscript">PDF to HTML Samples for VBScript</a> show how to convert PDF to HTML with the help of this tool.</p>
<p align="center">
