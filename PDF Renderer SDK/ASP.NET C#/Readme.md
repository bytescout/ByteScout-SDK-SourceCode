...
<p><a href="https://bytescout.com/products/developer/pdfrenderersdk/index.html">PDF Renderer SDK for ASP.NET</a> is an efficient program that can render PDF file and convert PDF to TIFF, PDF to BMP, PDF to EMF and PDF to PNG images and image elements with the possibilty to print the file after. The layout is preserved, the program works in .NET, ASP.NET and Visual Basic.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-renderer-sdk-samples-asp-net">PDF Renderer SDK Samples for ASP.NET</a> to show how to render PDF files using this tool.</p>
<p align="center">
