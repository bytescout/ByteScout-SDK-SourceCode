...
<li><strong>Product Home:</strong> <a href="https://bytescout.com/products/developer/pdfrenderersdk/index.html">PDF Renderer SDK</a></li>
<li><strong>Download:</strong> <a href="https://bytescout.com/download/web-installer">Download Free Trial</a></li>
<li><strong>Documentation:</strong> <a href="http://cdn.bytescout.com/help/BytescoutPDFRendererSDK/index.html?_ga=2.77457109.1900754050.1503438929-41333639.1490255915">PDF Renderer SDK Documentation</a></li>
...
<p><a href="https://bytescout.com/products/developer/pdfrenderersdk/index.html">PDF Renderer SDK for VBScript and VB6</a> is an efficient program that can render PDF file and convert PDF to TIFF, PDF to BMP, PDF to EMF and PDF to PNG images and image elements with the possibilty to print the file after. The layout is preserved, the program works in .NET, ASP.NET and Visual Basic.</p>
...
</p><p>This repository contains <a href="https://github.com/bytescout/pdf-renderer-sdk-samples-vbscript">PDF Renderer SDK Samples for VBScript</a> to show how to render PDF files using this tool.</p>
<p align="center">
