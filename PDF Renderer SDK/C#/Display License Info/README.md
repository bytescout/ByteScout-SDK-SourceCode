## How to display license info in C# and ByteScout PDF Renderer SDK ByteScout PDF Renderer SDK is the SDK for rendering of PDF into thumbnails and images in high quality. Provides various functions like batch processing, PNG, TIFF output. Can be used from web and desktop applications.
...
##### **DisplayLicenseInfo.NETCore.csproj:**
