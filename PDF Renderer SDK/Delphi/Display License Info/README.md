## How to display license info in Delphi and ByteScout PDF Renderer SDK What is ByteScout PDF Renderer SDK? It is the SDK for rendering of PDF into thumbnails and images in high quality. Provides various functions like batch processing, PNG, TIFF output. Can be used from web and desktop applications.
...
<BorlandProject>
	<PersonalityInfo>
		<Option>
			...
			<Option Name="GUID">{1A98310F-04C4-45C0-A457-8F5E697BB1E2}</Option>
		</Option>
	</PersonalityInfo>
	<Delphi.Personality>
		<Source>
			<Source Name="MainSource">DisplayLicenseInfo.dpr</Source>
		</Source>
		<FileVersion>
