## How to make thumbnail from PDF in Delphi and ByteScout PDF Renderer SDK ByteScout PDF Renderer SDK is the SDK for rendering of PDF into thumbnails and images in high quality. Provides various functions like batch processing, PNG, TIFF output. Can be used from web and desktop applications.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{76798C20-0D1C-4171-8B47-05F417017C97}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">MakeThumbnail.dpr</Source>
    </Source>
    <FileVersion>
