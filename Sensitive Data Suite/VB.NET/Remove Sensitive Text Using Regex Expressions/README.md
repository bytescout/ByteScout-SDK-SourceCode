## How to remove sensitive text using regex expressions in VB.NET with ByteScout Sensitive Data Suite
...
##### ****RemoveSensitiveTextUsingRegexExpressions.NETCore.vbproj:**
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <None Include="..\..\samplePDF_EmailAddress.pdf" Link="samplePDF_EmailAddress.pdf">
...
##### ****RemoveSensitiveTextUsingRegexExpressions.VS2005.vbproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <RootNamespace>RemoveSensitiveTextUsingRegexExpressions</RootNamespace>
    <AssemblyName>RemoveSensitiveTextUsingRegexExpressions</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>RemoveSensitiveTextUsingRegexExpressions.xml</DocumentationFile>
  ...
  <ItemGroup>
    <Content Include="..\..\samplePDF_EmailAddress.pdf">
      <Link>samplePDF_EmailAddress.pdf</Link>
      <CopyToOutputDirectory>Always</CopyToOutputDirectory>
    </Content>
  </ItemGroup>
...
##### ****RemoveSensitiveTextUsingRegexExpressions.VS2008.vbproj:**
...
##### ****RemoveSensitiveTextUsingRegexExpressions.VS2010.vbproj:**
