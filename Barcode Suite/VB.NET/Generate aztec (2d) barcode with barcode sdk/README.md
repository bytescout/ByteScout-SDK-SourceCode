## How to generate aztec (2d) barcode with barcode sdk in VB.NET and ByteScout Barcode Suite

### This code in VB.NET shows how to generate aztec (2d) barcode with barcode sdk with this how to tutorial

The documentation is designed for a specific purpose to help you to apply the features on your side. ByteScout Barcode Suite: the bundle that privides 3  SDK products to generate barcodes (Barcode SDK), read barcodes (Barcode Reaer SDK) and read and write spreadsheets (Spreadsheet SDK). It can generate aztec (2d) barcode with barcode sdk in VB.NET.
