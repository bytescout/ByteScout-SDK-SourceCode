## How to decode ean 5 barcode with barcode reader sdk in VB.NET with ByteScout Barcode Suite

### Learn to decode ean 5 barcode with barcode reader sdk in VB.NET

The sample source code below will teach you how to decode ean 5 barcode with barcode reader sdk in VB.NET. ByteScout Barcode Suite is the bundle that privides 3  SDK products to generate barcodes (Barcode SDK), read barcodes (Barcode Reaer SDK) and read and write spreadsheets (Spreadsheet SDK). It can be applied to decode ean 5 barcode with barcode reader sdk using VB.NET.
