## How to decode ean 13 barcode with barcode reader sdk in C# using ByteScout Barcode Suite

### Learn to decode ean 13 barcode with barcode reader sdk in C#

The sample source code below will teach you how to decode ean 13 barcode with barcode reader sdk in C#. ByteScout Barcode Suite is the set that includes three different SDK products to generate barcodes, read barcodes and read and write spreadsheets: Barcode SDK, Barcode Reader SDK and Spreadsheet SDK and you can use it to decode ean 13 barcode with barcode reader sdk with C#.
...
namespace ReadEAN13
{
    class Program
    {
        const string ImageFile = "EAN13.png";
