## How to use text auto corrections in Delphi with ByteScout Text Recognition SDK ByteScout Text Recognition SDK is the SDK designed to help developers in quick implementation of high quality OCR text recognition from scanned images and pdf.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{A4175782-86AA-4EF6-80AA-854B5B448B28}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">TextAutoCorrections.dpr</Source>
    </Source>
    <FileVersion>
