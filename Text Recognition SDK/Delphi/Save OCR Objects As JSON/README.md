## How to save OCR objects as JSON in Delphi using ByteScout Text Recognition SDK ByteScout Text Recognition SDK: the SDK designed to help developers in quick implementation of high quality OCR text recognition from scanned images and pdf.
...
<BorlandProject>
	<PersonalityInfo>
		<Option>
			...
			<Option Name="GUID">{4CA0BA60-11E7-4999-88B1-A6453499644E}</Option>
		</Option>
	</PersonalityInfo>
	<Delphi.Personality>
		<Source>
			<Source Name="MainSource">SaveOcrObjectAsJson.dpr</Source>
		</Source>
		<FileVersion>
