## How to merge two pdf documents with pdf sdk in VB.NET and ByteScout PDF Suite

### How to write a robust code in VB.NET to merge two pdf documents with pdf sdk with this step-by-step tutorial

These sample source codes on this page below are displaying how to merge two pdf documents with pdf sdk in VB.NET. ByteScout PDF Suite can merge two pdf documents with pdf sdk. It can be applied from VB.NET. ByteScout PDF Suite is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript.
