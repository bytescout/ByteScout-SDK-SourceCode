## How to make thumbnail image from pdf with pdf renderer sdk in VB.NET with ByteScout PDF Suite

### This code in VB.NET shows how to make thumbnail image from pdf with pdf renderer sdk with this how to tutorial

The sample source codes on this page shows how to make thumbnail image from pdf with pdf renderer sdk in VB.NET. ByteScout PDF Suite can make thumbnail image from pdf with pdf renderer sdk. It can be applied from VB.NET. ByteScout PDF Suite is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript.

The following code snippet for ByteScout PDF Suite works best when you need to quickly make thumbnail image from pdf with pdf renderer sdk in your VB.NET application. This VB.NET sample code is all you need for your app. Just copy and paste the code, add references (if needs to) and you are all set! Enjoy writing a code with ready-to-use sample codes in VB.NET.
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <PropertyGroup>
    ...
    <StartupObject>MakeThumbnail.Module1</StartupObject>
