## How to set passwords and permissions for pdf with pdf sdk in VB.NET with ByteScout PDF Suite
...
These source code samples are assembled by their programming language and functions they apply. ByteScout PDF Suite is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can set passwords and permissions for pdf with pdf sdk in VB.NET.
...
##### ****PasswordsAndPermissions.VS2005.vbproj:**
...
##### ****PasswordsAndPermissions.VS2008.vbproj:**
...
##### ****PasswordsAndPermissions.VS2010.vbproj:**
...
##### ****PasswordsAndPermissions.VS2012.vbproj:**
...
##### ****PasswordsAndPermissions.VS2013.vbproj:**
...
##### ****PasswordsAndPermissions.VS2015.vbproj:**
