## How to find keyword in pdf and extract text with pdf extractor sdk in VB.NET and ByteScout PDF Suite

### If you want to learn more then this tutorial will show how to find keyword in pdf and extract text with pdf extractor sdk in VB.NET
