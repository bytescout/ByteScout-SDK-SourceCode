...
### This code in VB.NET shows how to convert svg to pdf with pdf sdk with this how to tutorial
...
Want to quickly learn? This fast application programming interfaces of ByteScout PDF Suite for VB.NET plus the guidelines and the code below will help you quickly learn how to convert svg to pdf with pdf sdk. Just copy and paste the code into your VB.NET application’s code and follow the instructions. Use of ByteScout PDF Suite in VB.NET is also described in the documentation included along with the product.
...
<Project ToolsVersion="14.0" DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <StartupObject>ConvertSvgToPdf.Module1</StartupObject>
    <RootNamespace>ConvertSvgToPdf</RootNamespace>
    <AssemblyName>ConvertSvgToPdf</AssemblyName>
  ...
  <PropertyGroup Condition=" '$(Configuration)|$(Platform)' == 'Debug|AnyCPU' ">
    ...
    <DocumentationFile>ConvertSvgToPdf.xml</DocumentationFile>
