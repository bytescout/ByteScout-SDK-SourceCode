## How to add header and footer with pdf sdk in VB.NET with ByteScout PDF Suite

### This code in VB.NET shows how to add header and footer with pdf sdk with this how to tutorial

The documentation is designed for a specific purpose to help you to apply the features on your side. ByteScout PDF Suite is the set that includes 6 SDK products to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can be applied to add header and footer with pdf sdk using VB.NET.

The following code snippet for ByteScout PDF Suite works best when you need to quickly add header and footer with pdf sdk in your VB.NET application. Follow the instructions from scratch to work and copy the VB.NET code. Further improvement of the code will make it more robust.
