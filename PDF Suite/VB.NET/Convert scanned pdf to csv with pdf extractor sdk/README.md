## How to convert scanned pdf to csv with pdf extractor sdk in VB.NET and ByteScout PDF Suite

### Step-by-step tutorial on how to convert scanned pdf to csv with pdf extractor sdk in VB.NET

This sample source code below will display you how to convert scanned pdf to csv with pdf extractor sdk in VB.NET. ByteScout PDF Suite is the set that includes 6 SDK products to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can be applied to convert scanned pdf to csv with pdf extractor sdk using VB.NET.
