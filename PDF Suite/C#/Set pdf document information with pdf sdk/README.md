## How to set pdf document information with pdf sdk in C# using ByteScout PDF Suite

### Continuous learning is a crucial part of computer science and this tutorial shows how to set pdf document information with pdf sdk in C#

Quickly learn how to set pdf document information with pdf sdk in C# with this sample source code. What is ByteScout PDF Suite? It is the set that includes 6 SDK products to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can help you to set pdf document information with pdf sdk in your C# application.
...
##### ****DocumentInformation.NETCore.csproj:**
...
##### ****DocumentInformation.VS2005.csproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <RootNamespace>DocumentInformation</RootNamespace>
    <AssemblyName>DocumentInformation</AssemblyName>
...
##### ****DocumentInformation.VS2008.csproj:**
...
##### ****DocumentInformation.VS2010.csproj:**
...
##### ****DocumentInformation.VS2012.csproj:**
...
##### ****DocumentInformation.VS2013.csproj:**
...
##### ****DocumentInformation.VS2015.csproj:**
