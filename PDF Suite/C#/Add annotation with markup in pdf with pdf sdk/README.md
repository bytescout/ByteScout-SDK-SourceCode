## How to add annotation with markup in pdf with pdf sdk in C# using ByteScout PDF Suite

### Continuous learning is a crucial part of computer science and this tutorial shows how to add annotation with markup in pdf with pdf sdk in C#

The sample source code below will teach you how to add annotation with markup in pdf with pdf sdk in C#. Want to add annotation with markup in pdf with pdf sdk in your C# app? ByteScout PDF Suite is designed for it. ByteScout PDF Suite is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript.

 These C# code samples for C# guide developers to speed up coding of the application when using ByteScout PDF Suite. This C# sample code is all you need for your app. Just copy and paste the code, add references (if needs to) and you are all set! This basic programming language sample code for C# will do the whole work for you to add annotation with markup in pdf with pdf sdk.
...
##### ****MarkupAnnotation.NETCore.csproj:**
...
##### ****MarkupAnnotation.VS2005.csproj:**
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    ...
    <RootNamespace>MarkupAnnotation</RootNamespace>
    <AssemblyName>MarkupAnnotation</AssemblyName>
...
##### ****MarkupAnnotation.VS2008.csproj:**
...
##### ****MarkupAnnotation.VS2010.csproj:**
...
##### ****MarkupAnnotation.VS2012.csproj:**
...
##### ****MarkupAnnotation.VS2013.csproj:**
...
##### ****MarkupAnnotation.VS2015.csproj:**
