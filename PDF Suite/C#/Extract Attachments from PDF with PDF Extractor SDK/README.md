## How to extract attachments from PDF with PDF extractor SDK in C# and ByteScout PDF Suite
...
These sample source codes on this page below are displaying how to extract attachments from PDF with PDF extractor SDK in C#. What is ByteScout PDF Suite? It is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can help you to extract attachments from PDF with PDF extractor SDK in your C# application.

Want to quickly learn? This fast application programming interfaces of ByteScout PDF Suite for C# plus the guidelines and the code below will help you quickly learn how to extract attachments from PDF with PDF extractor SDK.  Simply copy and paste in your C# project or application you and then run your app! Enjoy writing a code with ready-to-use sample C# codes.
...
##### ****ExtractAttachments.NETCore.csproj:**
...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    ...
    <None Include="..\..\attachments.pdf" Link="attachments.pdf">
...
##### ****ExtractAttachments.VS2005.csproj:**
...
##### ****ExtractAttachments.VS2008.csproj:**
...
##### ****ExtractAttachments.VS2010.csproj:**
