## How to add header and footer with pdf sdk in C# with ByteScout PDF Suite

### Learning is essential in computer world and the tutorial below will demonstrate how to add header and footer with pdf sdk in C#

Add header and footer with pdf sdk is simple to apply in C# if you use these source codes below. Want to add header and footer with pdf sdk in your C# app? ByteScout PDF Suite is designed for it. ByteScout PDF Suite is the set that includes 6 SDK products to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript.
