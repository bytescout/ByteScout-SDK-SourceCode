## How to set blend mode for drawing in pdf with pdf sdk in C# with ByteScout PDF Suite

### This code in C# shows how to set blend mode for drawing in pdf with pdf sdk with this how to tutorial

Quickly learn how to set blend mode for drawing in pdf with pdf sdk in C# with this sample source code. ByteScout PDF Suite can set blend mode for drawing in pdf with pdf sdk. It can be applied from C#. ByteScout PDF Suite is the set that includes 6 SDK products to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript.
