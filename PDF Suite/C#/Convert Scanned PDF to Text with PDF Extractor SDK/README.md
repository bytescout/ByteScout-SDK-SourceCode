## How to convert scanned PDF to text with PDF extractor SDK in C# and ByteScout PDF Suite

### Learn to convert scanned PDF to text with PDF extractor SDK in C#

The sample shows instructions and algorithm of how to convert scanned PDF to text with PDF extractor SDK and how to make it run in your C# application. What is ByteScout PDF Suite? It is the bundle that provides six different SDK libraries to work with PDF from generating rich PDF reports to extracting data from PDF documents and converting them to HTML. This bundle includes PDF (Generator) SDK, PDF Renderer SDK, PDF Extractor SDK, PDF to HTML SDK, PDF Viewer SDK and PDF Generator SDK for Javascript. It can help you to convert scanned PDF to text with PDF extractor SDK in your C# application.

The SDK samples given below describe how to quickly make your application do convert scanned PDF to text with PDF extractor SDK in C# with the help of ByteScout PDF Suite. Follow the instructions from scratch to work and copy the C# code. Use of ByteScout PDF Suite in C# is also described in the documentation included along with the product.
...
##### ****ScannedPdfToText.NETCore.csproj:**
...
##### ****ScannedPdfToText.VS2005.csproj:**
...
##### ****ScannedPdfToText.VS2008.csproj:**
...
##### ****ScannedPdfToText.VS2010.csproj:**
...
##### ****ScannedPdfToText.VS2012.csproj:**
...
##### ****ScannedPdfToText.VS2013.csproj:**
...
##### ****ScannedPdfToText.VS2015.csproj:**
