## How to convert pdf to png with pdf renderer sdk in ASP.NET and ByteScout PDF Suite
...
<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="4.0">
  ...
  <PropertyGroup>
    ...
    <ProjectGuid>{8212F3BF-B5E3-4FB8-9776-AFC7D18C1EB2}</ProjectGuid>
    ...
    <VisualStudio>
      <FlavorProperties GUID="{349c5851-65df-11da-9384-00065b846f21}">
        <WebProjectProperties>
          ...
          <DevelopmentServerPort>7507</DevelopmentServerPort>
  ...
  <PropertyGroup>
    <PreBuildEvent>copy ..\..\..\multipage.pdf "$(ProjectDir)</PreBuildEvent>
  </PropertyGroup>
</Project>
```
