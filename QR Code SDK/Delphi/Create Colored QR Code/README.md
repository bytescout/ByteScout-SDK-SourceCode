## How to create colored QR code in Delphi with ByteScout QR Code ByteScout QR Code is QR Code generation library. It provides full control on the quality, features and encoding. Can embed logo image right into QR Code itself. Batch barcode generation, and many special features like vCard or URL encoding are also supported.
...
<BorlandProject>
  <PersonalityInfo>
    <Option>
      ...
      <Option Name="GUID">{5228A06D-3A29-40BB-9727-9EE1F3ACB2A5}</Option>
    </Option>
  </PersonalityInfo>
  <Delphi.Personality>
    <Source>
      <Source Name="MainSource">ColoredQRCode.dpr</Source>
    </Source>
    <FileVersion>
